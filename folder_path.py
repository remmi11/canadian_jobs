...
def findDWG():
        ...
        os.chdir('Y:/canadian office/jobs') 
        rootPath = os.getcwd()
        jobNumbers = []

        years = [f for f in os.listdir(os.getcwd()) if f.startswith('2')]
        ...
        for year in years:
            ...
            os.chdir(os.path.join(rootPath, year))
            ...
            for dirpath, dirnames, filenames in os.walk(os.getcwd()):
                    for filename in filenames:
                        ...
                        if filename.endswith(('.dwg','.DWG')):
                            job = os.path.basename(os.path.dirname(os.path.join(dirpath,filename)))
                            jobNumbers.append(job)
                    print ''
